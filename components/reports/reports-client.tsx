...
import { Member, Consumption, Deposit, Transaction, Food } from '@/lib/types'
...
export function ReportsClient({ members, consumptions, deposits, transactions, foods }: ReportsClientProps) {
  const { t } = useLanguage()
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="transactions">{t.reports.transactions}</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="overview" className="mt-4 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t.reports.dailySpending}</CardTitle>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t.reports.memberComparison}</CardTitle>
                <CardDescription>{t.reports.memberContributions}</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t.reports.foodPopularity}</CardTitle>
                <CardDescription>{t.reports.foodBreakdown}</CardDescription>
              </CardHeader>
              <CardContent>
